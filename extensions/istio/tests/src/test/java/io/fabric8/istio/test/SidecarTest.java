...
class SidecarTest {
  ...
  void testGet() {
    ...
    Sidecar service = client.sidecars().inNamespace("ns2").withName("service2").get();
  ...
  void testCreate() throws InterruptedException {
    ...
    server.expect().post().withPath("/apis/networking.istio.io/v1beta1/namespaces/ns2/sidecars")
      ...
      .once();
    service = client.sidecars().inNamespace("ns2").create(service);
    assertNotNull(service);
  ...
  void testDelete() throws InterruptedException {
    server.expect().delete().withPath("/apis/networking.istio.io/v1beta1/namespaces/ns3/sidecars/service3")
      ...
      .once();
    Boolean deleted = client.sidecars().inNamespace("ns3").withName("service3").delete();
    assertTrue(deleted);
  ...
  void testDeleteOrphan() throws InterruptedException {
    server.expect().delete().withPath("/apis/networking.istio.io/v1beta1/namespaces/ns3/sidecars/service3")
      .andReturn(HttpURLConnection.HTTP_OK, new SidecarBuilder().build())
      .once();
    Boolean deleted = client.sidecars().inNamespace("ns3").withName("service3").withPropagationPolicy(DeletionPropagation.ORPHAN).delete();
    assertTrue(deleted);
