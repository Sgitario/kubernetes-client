...
class PeerAuthenticationTest {
  ...
  void testGet() {
    ...
    PeerAuthentication service = client.peerAuthentications().inNamespace("ns2").withName("service2").get();
  ...
  void testCreate() throws InterruptedException {
    PeerAuthentication service = new PeerAuthenticationBuilder()
      ...
      .withMtls(new PeerAuthenticationMutualTLS(3))
      .endInternalSpec()
      .build();
    ...
    server.expect().post().withPath("/apis/security.istio.io/v1beta1/namespaces/ns2/peerauthentications")
      ...
      .once();
    service = client.peerAuthentications().inNamespace("ns2").create(service);
    assertNotNull(service);
    ...
    assertEquals("{\"apiVersion\":\"security.istio.io/v1beta1\","
        ...
        + "\"spec\":{\"mtls\":{\"mode\":3},\"selector\":{\"match_labels\":{\"app\":\"reviews\"}}}}",
  ...
  void testDelete() throws InterruptedException {
    server.expect().delete().withPath("/apis/security.istio.io/v1beta1/namespaces/ns3/peerauthentications/service3")
      ...
      .once();
    Boolean deleted = client.peerAuthentications().inNamespace("ns3").withName("service3").delete();
    assertTrue(deleted);
  ...
  void testDeleteOrphan() throws InterruptedException {
    server.expect().delete().withPath("/apis/security.istio.io/v1beta1/namespaces/ns3/peerauthentications/service3")
      .andReturn(HttpURLConnection.HTTP_OK, new PeerAuthenticationBuilder().build())
      .once();
    Boolean deleted = client.peerAuthentications().inNamespace("ns3").withName("service3").withPropagationPolicy(DeletionPropagation.ORPHAN).delete();
    assertTrue(deleted);
