...
class WorkloadEntryTest {
  ...
  void testGet() {
    ...
    WorkloadEntry service = client.workloadEntries().inNamespace("ns2").withName("service2").get();
  ...
  void testCreate() throws InterruptedException {
    ...
    server.expect().post().withPath("/apis/networking.istio.io/v1beta1/namespaces/ns2/workloadentries")
      ...
      .once();
    service = client.workloadEntries().inNamespace("ns2").create(service);
    assertNotNull(service);
    ...
    assertEquals("{\"apiVersion\":\"networking.istio.io/v1beta1\","
        ...
        + "\"spec\":{\"address\":\"2.2.2.2\",\"labels\":{\"app\":\"details-legacy\"},\"service_account\":\"details-legacy\"}}",
  ...
  void testDelete() throws InterruptedException {
    server.expect().delete().withPath("/apis/networking.istio.io/v1beta1/namespaces/ns3/workloadentries/service3")
      ...
      .once();
    Boolean deleted = client.workloadEntries().inNamespace("ns3").withName("service3").delete();
    assertTrue(deleted);
  ...
  void testDeleteOrphan() throws InterruptedException {
    server.expect().delete().withPath("/apis/networking.istio.io/v1beta1/namespaces/ns3/workloadentries/service3")
      .andReturn(HttpURLConnection.HTTP_OK, new WorkloadEntryBuilder().build())
      .once();
    Boolean deleted = client.workloadEntries().inNamespace("ns3").withName("service3").withPropagationPolicy(DeletionPropagation.ORPHAN).delete();
    assertTrue(deleted);
