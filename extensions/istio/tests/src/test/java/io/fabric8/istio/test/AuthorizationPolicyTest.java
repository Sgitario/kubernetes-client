...
class AuthorizationPolicyTest {
  ...
  void testGet() {
    ...
    AuthorizationPolicy service = client.authorizationPolicies().inNamespace("ns2").withName("service2").get();
  ...
  void testCreate() throws InterruptedException {
    ...
    server.expect().post().withPath("/apis/security.istio.io/v1beta1/namespaces/ns2/authorizationpolicies")
      ...
      .once();
    service = client.authorizationPolicies().inNamespace("ns2").create(service);
    assertNotNull(service);
  ...
  void testDelete() throws InterruptedException {
    server.expect().delete().withPath("/apis/security.istio.io/v1beta1/namespaces/ns3/authorizationpolicies/service3")
      ...
      .once();
    Boolean deleted = client.authorizationPolicies().inNamespace("ns3").withName("service3").delete();
    assertTrue(deleted);
  ...
  void testDeleteOrphan() throws InterruptedException {
    server.expect().delete().withPath("/apis/security.istio.io/v1beta1/namespaces/ns3/authorizationpolicies/service3")
      .andReturn(HttpURLConnection.HTTP_OK, new AuthorizationPolicyBuilder().build())
      .once();
    Boolean deleted = client.authorizationPolicies().inNamespace("ns3").withName("service3").withPropagationPolicy(DeletionPropagation.ORPHAN).delete();
    assertTrue(deleted);
